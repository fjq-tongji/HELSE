...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl3/CODA_mPLUG_Owl3_detail_captions_new.json')
    ...
    with open('./Each_stage_texts/mplug-Owl3/CODA_mPLUG_Owl3_detail_captions_neww.json', 'w', encoding='utf-8') as f:
