...
file_path_1 = './Ours_llava_7b_refined_desc_7_1_only_right_branch.json'
file_path_2 = './Ours_llava_7b_refined_desc_7_2_only_right_branch.json'
file_path_3 = './Ours_llava_7b_refined_desc_7_3_only_right_branch.json'
file_path_4 = './Ours_llava_7b_refined_desc_7_4_only_right_branch.json'
final_lst = []
final_path = './Ours_llava_7b_refined_desc_7_only_right_branch.json'
