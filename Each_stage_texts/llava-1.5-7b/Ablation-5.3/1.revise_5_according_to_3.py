...
input_json_stage5 = './Ours_llava_7b_groundingdino_captions_5_4-m125.json'     ###只有ram_plus_nouns和ram_plus_nouns_captions
input_json_stage4_groundingdino = '../../Ours_llava_7b_ram_0.5_groundingdino_4_4.json'   ###这里的ram_plus_nouns_groundingdino是能用的
output_json = './Ours_llava_7b_groundingdino_captions_5_4_Ablation5.3.json'
...
for k in range(len(stage_3)):
    ...
    new_dict['named_entity_blip2_instructblip_update_5.3'] = stage_3[k]['named_entity_blip2_instructblip_update_5.3']
    ...
    ################################2.模块3输出的总的词
    module_5_3_zong_words_yuan = stage_3[k]['named_entity_blip2_instructblip_update_5.3']
