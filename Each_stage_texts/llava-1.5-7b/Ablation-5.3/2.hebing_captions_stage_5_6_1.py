...
final = []
input_json = './Ours_llava_7b_groundingdino_captions_5_4_Ablation5.3.json'     ###模块5输出的结果
input_json_2 = './Ours_llava_7b_entity_captions_update_6_4_new.json'   ###模块6输出的结果
output_json = './Ours_llava_7b_refined_desc_7_4_m5.3.json'
...
for k in range(len(stage_55)):
    ...
    ######################## 对阶段6的输出整合成一段话
    refined_passages_stage_6 = ' '.join(stage_66[k]['named_entity_split_sents_update_5.3'])   ###阶段6得到的一段话str
