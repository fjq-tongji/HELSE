...
file_path_1 = './Ours_llava_7b_refined_desc_7_1_m5.2.json'
file_path_2 = './Ours_llava_7b_refined_desc_7_2_m5.2.json'
file_path_3 = './Ours_llava_7b_refined_desc_7_3_m5.2.json'
file_path_4 = './Ours_llava_7b_refined_desc_7_4_m5.2.json'
final_lst = []
final_path = './Ours_llava_7b_refined_desc_7_m5.2.json'
