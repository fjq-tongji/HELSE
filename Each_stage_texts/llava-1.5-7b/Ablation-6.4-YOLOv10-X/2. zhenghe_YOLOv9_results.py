...
with open('./Ours_llava_7b_entity_captions_update_6_1.json', 'r', encoding='utf-8') as f:
    results_1 = json.load(f)

with open('./YOLOv10_x_results_gai.json', 'r', encoding='utf-8') as f:
...
for k in results_1:
    ...
    for j in Tag2text_results:
        if j['img_path'] == find_img:
            ...
            new_dict['YOLOv10_x_results'] = j['YOLOv10_x_results']
            final.append(new_dict)
            break

with open('Ours_llava_7b_entity_captions_update_6_1_new.json', 'w') as f:
