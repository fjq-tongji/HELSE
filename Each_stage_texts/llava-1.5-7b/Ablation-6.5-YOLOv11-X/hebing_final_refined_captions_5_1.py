...
final = []
input_json = './Ours_llava_7b_YOLOv11_x_captions_5_4.json'
output_json = './Ours_llava_7b_YOLO11_x_refined_desc_7_4.json'
...
for k in range(len(stage_6)):
    ...
    zhenghe_stage5 = []
    for each_sent in stage_6[k]['YOLO11_x_nouns_captions']:
