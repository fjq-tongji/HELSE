...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/llava-7b/Ablation-5.1/Ours_llava_7b_entity_update_3_1.json')
    ...
    with open('./Each_stage_texts/llava-7b/Ablation-5.1/Ours_llava_7b_entity_captions_update_6_1_new.json', 'w', encoding='utf-8') as f:
