...
final = []
input_json = './Ours_llava_7b_Tag2text_captions_5_3.json'
output_json = './Ours_llava_7b_Tag2text_refined_desc_7_3.json'
...
for k in range(len(stage_6)):
    ...
    zhenghe_stage5 = []
    for each_sent in stage_6[k]['Tag2text_nouns_captions']:
