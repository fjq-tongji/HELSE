...
final = []
input_json = './Ours_llava_7b_YOLOv9_e_captions_5_4.json'
output_json = './Ours_llava_7b_YOLOv9_e_refined_desc_7_4.json'
...
for k in range(len(stage_6)):
    ...
    zhenghe_stage5 = []
    for each_sent in stage_6[k]['YOLOv9_e_nouns_captions']:
