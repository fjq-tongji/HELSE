...
output_json = './Ours_llava_7b_groundingdino_captions_5_4_Ablation5.5.json'
...
for k in range(len(stage_3)):
    ...
    new_dict['named_entity_blip2_instructblip_update_5.5'] = stage_3[k]['named_entity_blip2_instructblip_update_5.5']
    ...
    ################################2.模块3输出的总的词
    module_5_3_zong_words_yuan = stage_3[k]['named_entity_blip2_instructblip_update_5.5']
