...
final = []
input_json = './Ours_llava_7b_groundingdino_captions_5_3.json'
output_json = './Ours_llava_7b_refined_desc_7_3_m125.json'
...
for k in range(len(stage_6)):
    ...
    ######################## 对阶段6的输出整合成一段话
    refined_passages_stage_6 = stage_6[k]['input_desc']   ###阶段6得到的一段话str
