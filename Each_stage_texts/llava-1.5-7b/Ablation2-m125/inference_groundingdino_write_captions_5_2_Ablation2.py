...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/llava-7b/Ablation2-m125/Ours_llava_7b_ram_0.5_nouns_2_2.json')
    ...
    with open('./Each_stage_texts/llava-7b/Ablation2-m125/Ours_llava_7b_groundingdino_captions_5_2.json', 'w', encoding='utf-8') as f:
