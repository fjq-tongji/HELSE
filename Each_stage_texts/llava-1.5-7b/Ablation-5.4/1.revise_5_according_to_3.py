...
final = []
input_json_stage3 = './Ours_llava_7b_entity_update_3_2.json'                    ###模块3输出的结果,有右分支最后的实体。涉及到左分支ram的都用不了，是基于ram0.6的结果
input_json_stage5 = '../Ablation2-m125/Ours_llava_7b_groundingdino_captions_5_2.json'     ###只有ram_plus_nouns和ram_plus_nouns_captions
input_json_stage4_groundingdino = '../../Ours_llava_7b_ram_0.5_groundingdino_4_2.json'   ###这里的ram_plus_nouns_groundingdino是能用的
output_json = './Ours_llava_7b_groundingdino_captions_5_2_Ablation5.4.json'
...
for k in range(len(stage_3)):
    ...
    new_dict['named_entity_blip2_instructblip_update_5.4'] = stage_3[k]['named_entity_blip2_instructblip_update_5.4']
    ...
    ################################2.模块3输出的总的词
    module_5_3_zong_words_yuan = stage_3[k]['named_entity_blip2_instructblip_update_5.4']
