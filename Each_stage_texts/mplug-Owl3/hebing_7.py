...
file_path_1 = './Ours_mplug_owl3_refined_desc_7_1.json'
file_path_2 = './Ours_mplug_owl3_refined_desc_7_2.json'
file_path_3 = './Ours_mplug_owl3_refined_desc_7_3.json'
file_path_4 = './Ours_mplug_owl3_refined_desc_7_4.json'
final_lst = []
final_path = './Ours_mplug_owl3_refined_desc_7.json'
