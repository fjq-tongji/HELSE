...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/MiniGPT-4/RAM_plus_results_0.3_3.json')
    ...
    with open('./Each_stage_texts/RAM_plus_results_0.3_groundingdino_3.json', 'w', encoding='utf-8') as f:
