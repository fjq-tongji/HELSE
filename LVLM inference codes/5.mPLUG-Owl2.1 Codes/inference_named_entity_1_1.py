...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2.1/CODA_mPLUG_Owl2_1_detail_captions_new2_1.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_detail_caption_entity_1.json', 'w', encoding='utf-8') as f:
