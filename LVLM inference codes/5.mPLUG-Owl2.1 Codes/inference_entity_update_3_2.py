...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_entity_instructblip_3_2_new.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_entity_update_3_2.json', 'w', encoding='utf-8') as f:
