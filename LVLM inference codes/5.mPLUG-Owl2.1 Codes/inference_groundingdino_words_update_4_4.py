...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_ram_0.5_groundingdino_integrate_4_4.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_groundingdino_words_update_4_4.json', 'w', encoding='utf-8') as f:
