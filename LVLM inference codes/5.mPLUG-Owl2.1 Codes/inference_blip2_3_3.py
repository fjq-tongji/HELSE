...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_detail_caption_entity_3.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2.1/Ours_mplug_owl2_1_entity_blip2_3_3.json', 'w', encoding='utf-8') as f:
