...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2.1/CODA_mPLUG_Owl2_1_detail_captions_new.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2.1/CODA_mPLUG_Owl2_1_detail_captions_neww.json', 'w', encoding='utf-8') as f:
