...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/Ours_llava_7b_groundingdino_words_update_4_2.json')
    ...
    with open('./Each_stage_texts/Ours_llava_7b_groundingdino_captions_5_2.json', 'w', encoding='utf-8') as f:
