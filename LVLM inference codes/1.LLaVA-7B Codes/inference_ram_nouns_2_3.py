...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/RAM_plus_results_0.5_3.json')
    ...
    with open('./Each_stage_texts/RAM_plus_results_0.5_nouns_3.json', 'w', encoding='utf-8') as f:
