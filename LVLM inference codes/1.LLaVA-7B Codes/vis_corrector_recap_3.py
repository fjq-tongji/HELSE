...
from models.update_entity_5_4 import Update_entity
#from models.update_entity_5_5 import Update_entity
...
class Corrector:
    ...
    def correct(self, pipeline, processor_blip, model_blip, processor_instructblip, model_instructblip,
        ...
        #print('------------4------------')
        #sample = self.instructblip_detect.instructblip_detect_objects(processor_instructblip, model_instructblip, sample)
        # print('------------4------------')
