...
from models.update_entity_5_1 import Update_entity
...
#from models.update_entity_sents_5_3 import Update_entity_captions
#from models.update_entity_sents_5_2 import Update_entity_captions
#from models.update_entity_sents_5_1 import Update_entity_captions
from models.update_entity_sents_5_5_new import Update_entity_captions
...
class Corrector:
    ...
    def correct(self, pipeline, processor_blip, model_blip, processor_instructblip, model_instructblip, sample: Dict):
        '''
        ...
        # print('------------3------------')
        #sample = self.entity_update.filter_entity(sample, pipeline)
        # print('------------3------------')
        #sample = self.groundingdino.detect_objects(sample, pipeline)
        # print('------------4------------')
        #sample = self.blip2_detect.blip2_detect_objects(processor_blip, model_blip, sample)
        #print('------------4------------')
