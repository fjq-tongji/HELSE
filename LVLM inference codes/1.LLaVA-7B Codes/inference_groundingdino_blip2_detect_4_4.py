...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/llava-7b/RAM-0.3/Ours_llava_7b_ram_0.3_groundingdino_integrate_4_4.json')
    ...
    with open('./Each_stage_texts/llava-7b/RAM-0.3/Ours_llava_7b_ram_0.3_groundingdino_blip2_detect_4_4.json', 'w', encoding='utf-8') as f:
