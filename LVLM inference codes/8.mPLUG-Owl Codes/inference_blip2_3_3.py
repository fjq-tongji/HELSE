...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_detail_caption_entity_3.json')
    ...
    with open('./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_entity_blip2_3_3.json', 'w', encoding='utf-8') as f:
