...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_ram_0.5_groundingdino_integrate_4_3.json')
    ...
    with open('./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_groundingdino_words_update_4_3.json', 'w', encoding='utf-8') as f:
