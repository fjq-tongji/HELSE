...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_entity_instructblip_3_4.json')
    ...
    with open('./Each_stage_texts/mplug-Owl3/Ours_mplug_owl3_entity_update_3_4.json', 'w', encoding='utf-8') as f:
