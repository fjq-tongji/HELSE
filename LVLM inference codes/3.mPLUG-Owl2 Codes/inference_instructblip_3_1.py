...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_entity_blip2_3_1.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_entity_instructblip_3_1.json', 'w', encoding='utf-8') as f:
