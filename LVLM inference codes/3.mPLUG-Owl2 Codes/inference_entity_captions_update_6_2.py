...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_groundingdino_captions_5_2.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_entity_captions_update_6_2.json', 'w', encoding='utf-8') as f:
