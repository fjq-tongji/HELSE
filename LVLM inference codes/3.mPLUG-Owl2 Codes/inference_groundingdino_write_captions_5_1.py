from vis_corrector_recap_w2 import Corrector
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_groundingdino_words_update_4_1_new.json')
    ...
    with open('./Each_stage_texts/mplug-Owl2/Ours_mplug_owl2_groundingdino_captions_5_1_new.json', 'w', encoding='utf-8') as f:
