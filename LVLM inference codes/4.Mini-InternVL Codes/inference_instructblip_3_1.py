from vis_corrector_recap_v3 import Corrector
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mini-internvl/Ours_mini_internvl_entity_blip2_3_1.json')
    ...
    for sample in coda_detail_captions:
        output = corrector.correct(pipeline, pipeline, pipeline, processor_instructblip, model_instructblip,
    ...
    with open('./Each_stage_texts/mini-internvl/Ours_mini_internvl_entity_instructblip_3_1.json', 'w', encoding='utf-8') as f:
