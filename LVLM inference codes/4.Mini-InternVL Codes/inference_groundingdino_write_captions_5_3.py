from vis_corrector_recap_v6_2 import Corrector
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mini-internvl/Ours_mini_internvl_groundingdino_words_update_4_3_new.json')
    ...
    with open('./Each_stage_texts/mini-internvl/Ours_mini_internvl_groundingdino_captions_5_3_new.json', 'w', encoding='utf-8') as f:
