from vis_corrector_recap_v2 import Corrector
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mini-internvl/Ours_mini_internvl_detail_caption_entity_3.json')
    ...
    with open('./Each_stage_texts/mini-internvl/Ours_mini_internvl_entity_blip2_3_3.json', 'w', encoding='utf-8') as f:
