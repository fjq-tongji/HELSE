...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts/mini-internvl/Ours_mini_internvl_ram_0.5_groundingdino_integrate_4_4_new.json')
    ...
    with open('./Each_stage_texts/mini-internvl/Ours_mini_internvl_groundingdino_words_update_4_4_new.json', 'w', encoding='utf-8') as f:
