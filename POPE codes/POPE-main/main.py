...
def parse_args():
    ...
    parser.add_argument("--auto_seg", type=bool, default=True, help="Whether to use automatic segmentation")
    parser.add_argument("--img_path", type=str, default="./CODA2022_img_name.json", help="The path to images to be segmented")
    parser.add_argument("--seg_path", type=str, default="./CODA2022_img_name_segmentation_results.json", help="The segmentation file")
    ...
    parser.add_argument("--img_num", type=int, default=9768, help="The number of images used for building POPE")
